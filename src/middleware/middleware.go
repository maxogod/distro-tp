...
type MessageMiddleware[T any] interface {
    ...
    */
    StartConsuming(m *T, onMessageCallback onMessageCallback) (void, error MessageMiddlewareError)
    ...
    Si se pierde la conexión con el middleware eleva MessageMiddlewareDisconnectedError.
    */
    StopConsuming(m *T) (void, error MessageMiddlewareError) (void, error MessageMiddlewareError)
    ...
    Si ocurre un error interno que no puede resolverse eleva MessageMiddlewareMessageError.
    */
    Send(m *T, message []byte) (void, error MessageMiddlewareError) (void, error MessageMiddlewareError)

    /*
    Se desconecta de la cola o exchange al que estaba conectado.
    Si ocurre un error interno que no puede resolverse eleva MessageMiddlewareCloseError.
    */
    Close(m *T) (void, error MessageMiddlewareError) (void, error MessageMiddlewareError)
    ...
    */    
    Delete(m *T) (void, error MessageMiddlewareError) (void, error MessageMiddlewareError)
}
